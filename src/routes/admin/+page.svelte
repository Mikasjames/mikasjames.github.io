								...
								>
									...
									>
										...
										>
											...
											/>
											<path
												d="M8 14h2l1.5 2 2-3 2.5 3H18V8l-3.5 3-2-2L8 14Z"
											/>
										</svg>
									</button>
						...
						>
							...
							>
								<div>
									...
									<p class="text-[10px] text-zinc-550 mt-0.5">
										Upload new assets or reuse existing
										gallery images.
									</p>
								</div>
							...
							{#if mediaLoadError}
								...
								>
									...
									>
										Please ensure your Firestore Security
										Rules permit read/write access to the <code
							...
							{:else}
								<p class="text-xs text-zinc-650 py-2">
									No images found in your media gallery.
						...
						<div class="space-y-2">
							...
							>
								...
								<div class="flex items-center gap-3">
									...
									<div
										class="flex text-xs font-medium rounded-lg border border-zinc-800/80 overflow-hidden"
									>
										<button
											type="button"
											onclick={() =>
												(activeTab = "write")}
											class="px-3 py-1.5 transition-colors {activeTab ===
											'write'
							...
							{#if activeTab === "write"}
								...
								>
									...
									<label
										class="p-1.5 rounded hover:bg-zinc-800 text-zinc-400 hover:text-zinc-100 transition-colors cursor-pointer flex items-center justify-center min-w-[28px] h-[28px]"
									...
									{#if contentUploading}
										<div
											class="flex items-center gap-1 px-1.5 text-xs text-zinc-500 self-center"
										>
											<div
								...
								<textarea
									id="journal-content"
									bind:this={textareaRef}
									bind:value={journalForm.content}
									onkeydown={handleKeyDown}
									required
									rows="16"
							...
							{:else}
								<div
									class="min-h-[300px] px-4 py-3 rounded-lg bg-zinc-900/40 border border-zinc-800/60 prose-custom text-zinc-400 text-sm leading-relaxed"
								>
									{#if journalForm.content}
										<!-- eslint-disable-next-line svelte/no-at-html-tags -->
										{@html renderMarkdown(
